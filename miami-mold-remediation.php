...
<div class="page-head mold">
    <div class="vertical">

        <h1 class="page-title">Miami Mold Remediation</h1>
        <p>DON’T LET MOLD AFFECT YOUR HEALTH AND HOME</p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class=" col-sm-6 col-md-2">
                <div class="services-item-page-mold">
                     <div class="services-icon"><img src="images/mold.png"/></div>
                </div>
            </div>
            <div class="col-sm-6 col-md-10">
                <h5 class="single-subtitle green">Mold Remediation Service You Can Count On</h5>
                ...
                <h5 class="single-subtitle green">What You Can Expect</h5>
